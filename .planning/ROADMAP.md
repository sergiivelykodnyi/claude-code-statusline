...
- [ ] **Phase 1: Core Status Line from Stdin** - Two-line colorized status with model, effort, directory, context, and rate limits rendered entirely from the stdin payload
